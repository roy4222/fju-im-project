...
import { useIsMobile } from "@/app/_ui/ui/use-mobile"
import { cn } from "@/shared/cn"
import { Button } from "@/app/_ui/ui/button"
import { Input } from "@/app/_ui/ui/input"
import { Separator } from "@/app/_ui/ui/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@/app/_ui/ui/sheet"
import { Skeleton } from "@/app/_ui/ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>後台選單</SheetTitle>
            <SheetDescription>各功能頁的入口。</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <IconLayoutSidebar />
      <span className="sr-only">側欄選單</span>
    </Button>
  )
}
...
function SidebarMenuSkeleton({
  ...
  // 原版用 style 帶隨機寬度；正式站 CSP 會擋 style 屬性，改成固定寬度。
  return (
    <div
